...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 ELK 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://github.com/deviantony/docker-elk#requirements)）：
...
启动应用后，本地浏览器访问 URL: *`http://服务器公网IP:9200`* 进入应用。  
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| elk-elasticsearch | 9200 | 数据搜索引擎 | Y |
| elk-kibana | 9001 | 数据库可视化WEB管理工具 | Y |
| elk-logstash | 5044 | 数据收集器 | Y |
## 文档

[ELK 管理员手册](https://support.websoft9.com/docs/elk)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [ELK 企业级支持版](https://apps.websoft9.com/elk) 
